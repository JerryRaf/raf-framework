...
- ✅ **Spring Boot 3 原生支持**：基于 Sentry Spring Boot Starter（版本见[依赖版本清单](../../../docs-site/components/dependency-versions.md)）
...
完整版本信息见 [依赖版本清单](../../../docs-site/components/dependency-versions.md)。
...
- ✨ 全面重构，升级 Sentry Spring Boot Starter
